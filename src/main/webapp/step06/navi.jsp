...
=======
	          <li class="nav-item"><a href='<c:url value="/step06/index.jsp#contact-section"/>' class="nav-link"><span>Contact</span></a></li>
>>>>>>> 41e8ef6888d484f1d11e5d0284a898be54e0c4c7
...
=======
  						<a href='<c:url value = "moneyCehck.jsp?id=<%=sessionId%>"/>' style ="color:pink" class="dropdown-item">[<b>잔액: </b><%=money %>]</a>
>>>>>>> 41e8ef6888d484f1d11e5d0284a898be54e0c4c7
  				 	</div>
	          	</div>
	          </c:otherwise>
